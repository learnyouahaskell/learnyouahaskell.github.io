...
Then, when we get a value of type `Either a b`, we usually pattern match on both `Left` and `Right`, and we do different stuff based on which one of them it was.
